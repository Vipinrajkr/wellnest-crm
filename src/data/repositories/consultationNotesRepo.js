// data/repositories/consultationNotesRepo.js
// Only module allowed to open a transaction against the
// 'consultationNotes' store. Exposes a small CRUD API; no validation or
// business rules here — that lives in domain/consultationNotes.

import { getStore } from '../db.js';
import { requestToPromise, txDone } from '../idbUtils.js';

const STORE_NAME = 'consultationNotes';

export const consultationNotesRepo = {
  async getAll() {
